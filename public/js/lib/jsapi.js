...
if (!window['google']['loader']) {
    ...
    (function () {
        ...
        n(google, function (a, b, c) {
            function e(a) {
                ...
                if ("undefined" != typeof b[1]) f = b[0], c.packages = c.packages || [], c.packages[p](b[1])
            }
            var f = a,
                c = c || {};
            ...
            if (a = N[":" + f]) {
                ...
                if (c && "string" == typeof c.callback && (i = c.callback, i.match(/^[[\]A-Za-z0-9._]+$/))) i = l.eval(i), c.callback = i;
        ...
        google[A].N = function () {
            ...
            if ("complete" == a.readyState) a.onreadystatechange = h, a.parentNode.removeChild(a), R()
        };
        ...
        google[A].d = function (a, b, c) {
            if (c) {
                var e;
                if ("script" == a) e = m.createElement("script"), e.type = "text/javascript", e.src = b;
                else if ("css" == a) e = m.createElement("link"), e.type = "text/css", e.href = b, e.rel = "stylesheet";
        ...
        n(V[y], function (a, b) {
            ...
            if (c[x]) {
                ...
                if (!b && O[":" + this.a] != h && O[":" + this.a].versions[":" + a] != h && !google[A].AdditionalParams && this.j) {
                    ...
                    for (var S in c.properties) S && ":" == S[r](0) && (google[this.a][S[B](1)] = c.properties[S]);
                ...
                if (this.j && (this.j = j, this.c = (new Date)[w](), 1 != this.c % 100)) this.c = -1;
                for (o = 0; o < i[x]; o++) s = i[o], this.e[":" + s] = g
            }
        });
        V[y].l = function (a) {
            if (-1 != this.c) ca("al_" + this.a, "jl." + ((new Date)[w]() - this.c), g), this.c = -1;
    ...
    google.loader.rfm({
        ":search": {
            ...
            "path": "/api/search/1.0/c635244b28d6c397d2d5ccc22fd3126d/",
            "js": "default+en.I.js",
            "css": "default+en.css",
            "properties": {
                ":JSHash": "c635244b28d6c397d2d5ccc22fd3126d",
                ":NoOldNames": false,
                ":Version": "1.0"
            }
        },
        ":language": {
            ...
            "path": "/api/language/1.0/57e8a5e8a66c850696b5c616d4a4fdb1/",
            "js": "default+en.I.js",
            "properties": {
                ":JSHash": "57e8a5e8a66c850696b5c616d4a4fdb1",
                ":Version": "1.0"
            }
        },
        ":feeds": {
        ...
        ":ima": {
            ...
            "path": "/api/ima/1.6/8ddd05e4b8e2e0abf8d77f8a73259043/",
            "js": "default.I.js",
            "properties": {
                ":JSHash": "8ddd05e4b8e2e0abf8d77f8a73259043",
                ":Version": "1.6"
            }
        },
        ":wave": {
        ...
        ":annotations": {
            ...
            "path": "/api/annotations/1.0/ad1565d879cca9982c9467668024f1ac/",
            "js": "default+en.I.js",
            "properties": {
                ":JSHash": "ad1565d879cca9982c9467668024f1ac",
                ":Version": "1.0"
            }
        },
        ":picker": {
            ...
            "path": "/api/picker/1.0/b7e9eb7fd8c0e098a7173ce367b2b5c1/",
            "js": "default.I.js",
            "css": "default.css",
            "properties": {
                ":JSHash": "b7e9eb7fd8c0e098a7173ce367b2b5c1",
                ":Version": "1.0"
            }
        }
    });
