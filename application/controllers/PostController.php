...
class PostController extends BaseController
{
    ...
    public function postcommentAction() {
        ...
        $subject = $author_firstname.' commented your post';
        $bodyText = "Hi $poster_firstname,<br><br>$author_firstname commented on your post. Please follow the link to view the comment:<br><br><a href='http://$server_host/post/item?id=$post_id'>$server_host/post/item?id=$post_id</a><br><br>The feedbakLOOP Team";
        $to = $poster_email;
